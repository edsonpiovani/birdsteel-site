...
$title = 'Caixa de Comando Metálica | BIRDSTEEL';
$description = 'Caixas metálicas para comandos, acionamentos, automação e interfaces técnicas sob medida.';
$canonical = site_url('/caixa-de-comando/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Caixa de Comando Metálica</h1>
      <p class="lead">Caixas metálicas para comandos, acionamentos, automação e interfaces técnicas sob medida.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Aplicação conforme comandos previstos.</li>
<li>Furações para botões e sinalizadores sob desenho.</li>
<li>Escopo elétrico precisa ser validado.</li></ul>
    </aside>
  </div>
</section>
