...
$title = 'Totem Residencial com Número | BIRDSTEEL';
$description = 'Totens residenciais personalizados para identificação de fachadas, entradas, jardins e muros.';
$canonical = site_url('/totem-residencial-com-numero/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Totem Residencial com Número</h1>
      <p class="lead">Totens residenciais personalizados para identificação de fachadas, entradas, jardins e muros.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Número e nome da rua sob medida.</li>
<li>Proporção conforme fachada.</li>
<li>Iluminação e instalação sob avaliação.</li></ul>
    </aside>
  </div>
</section>
