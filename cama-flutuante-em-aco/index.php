...
$title = 'Cama Flutuante em Aço | BIRDSTEEL';
$description = 'Estrutura metálica residencial com efeito visual moderno, fabricada conforme medidas e avaliação técnica.';
$canonical = site_url('/cama-flutuante-em-aco/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Cama Flutuante em Aço</h1>
      <p class="lead">Estrutura metálica residencial com efeito visual moderno, fabricada conforme medidas e avaliação técnica.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Medidas do colchão e ambiente.</li>
<li>Estrutura sob avaliação de fixação e uso.</li>
<li>Acabamento e pintura personalizados.</li></ul>
    </aside>
  </div>
</section>
