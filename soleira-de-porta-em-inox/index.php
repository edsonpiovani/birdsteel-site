...
$title = 'Soleira de Porta em Inox | BIRDSTEEL';
$description = 'Soleiras em inox para portas, passagens, transições de piso e acabamento residencial.';
$canonical = site_url('/soleira-de-porta-em-inox/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Soleira de Porta em Inox</h1>
      <p class="lead">Soleiras em inox para portas, passagens, transições de piso e acabamento residencial.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Medidas conforme vão da porta.</li>
<li>Acabamento em inox sob avaliação.</li>
<li>Aplicação em portas e áreas de passagem.</li></ul>
    </aside>
  </div>
</section>
