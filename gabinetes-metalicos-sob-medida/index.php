...
$title = 'Gabinetes Metálicos Sob Medida | BIRDSTEEL';
$description = 'Gabinetes metálicos para telecom, network, energia, automação e aplicações técnicas.';
$canonical = site_url('/gabinetes-metalicos-sob-medida/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Gabinetes Metálicos Sob Medida</h1>
      <p class="lead">Gabinetes metálicos para telecom, network, energia, automação e aplicações técnicas.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Medidas conforme equipamentos.</li>
<li>Portas, fechamentos e ventilação sob avaliação.</li>
<li>Acabamento conforme aplicação.</li></ul>
    </aside>
  </div>
</section>
