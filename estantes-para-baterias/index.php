...
$title = 'Estantes para Baterias | BIRDSTEEL';
$description = 'Estantes metálicas para organização de baterias em níveis, prateleiras ou módulos.';
$canonical = site_url('/estantes-para-baterias/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Estantes para Baterias</h1>
      <p class="lead">Estantes metálicas para organização de baterias em níveis, prateleiras ou módulos.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Organização por nível ou módulo.</li>
<li>Medidas conforme bateria e ambiente.</li>
<li>Carga e escopo precisam de validação.</li></ul>
    </aside>
  </div>
</section>
