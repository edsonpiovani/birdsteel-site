...
$title = 'Grades de Proteção Sob Medida | BIRDSTEEL';
$description = 'Grades metálicas para janelas, portas, varandas e áreas externas conforme medidas do imóvel.';
$canonical = site_url('/grades-de-protecao-sob-medida/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Grades de Proteção Sob Medida</h1>
      <p class="lead">Grades metálicas para janelas, portas, varandas e áreas externas conforme medidas do imóvel.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Medidas e fotos do local são essenciais.</li>
<li>Acabamento conforme exposição.</li>
<li>Instalação sob avaliação.</li></ul>
    </aside>
  </div>
</section>
