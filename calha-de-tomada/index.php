...
$title = 'Calha de Tomada Metálica | BIRDSTEEL';
$description = 'Calhas metálicas para organização de pontos de energia em bancadas, racks e estruturas técnicas.';
$canonical = site_url('/calha-de-tomada/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Calha de Tomada Metálica</h1>
      <p class="lead">Calhas metálicas para organização de pontos de energia em bancadas, racks e estruturas técnicas.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Comprimento e pontos conforme projeto.</li>
<li>Parte elétrica deve ser definida no escopo.</li>
<li>Aplicação em racks, bancadas ou painéis.</li></ul>
    </aside>
  </div>
</section>
