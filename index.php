...
// BIRDSTEEL — Home final em PHP
// Arquivo sugerido: /index.php
...
?>
  ...
  <section class="hero hero-home" aria-labelledby="home-title">
    <div class="container hero-grid">
      <div class="hero-content">
        ...
        <h1 id="home-title">Soluções metálicas sob medida para empresas e residências</h1>
        <p class="hero-lead">
          A BIRDSTEEL fabrica racks, gabinetes, painéis, caixas metálicas, totens residenciais, grades, soleiras em inox, camas flutuantes e projetos personalizados em aço, inox e alumínio.
        </p>
        ...
        <ul class="hero-highlights" aria-label="Diferenciais principais">
          ...
          <li>Linha empresarial e residencial</li>
          <li>Atendimento em Boituva e região</li>
        </ul>
      </div>

      <figure class="hero-media">
        <img src="/assets/img/institucional/birdsteel-solucoes-metalicas-home.webp" alt="Composição visual conceitual com rack, painel elétrico e totem residencial representando as soluções metálicas da BIRDSTEEL" width="1200" height="900" fetchpriority="high">
        <figcaption>Imagem conceitual da linha BIRDSTEEL aplicada na Home para referência visual do projeto.</figcaption>
      </figure>
    </div>
  </section>
  ...
  <section class="section section-intro" aria-labelledby="intro-title">
    <div class="container narrow">
      ...
      <p>
        A BIRDSTEEL atua desde 2011 com soluções metálicas para diferentes necessidades. A empresa atende demandas empresariais, industriais, técnicas e residenciais, sempre avaliando medidas, aplicação, acabamento, material e viabilidade do projeto.
      </p>
      <p>
  ...
  <section class="section section-lines" aria-labelledby="linhas-title">
    <div class="container">
  ...
  <section class="section section-products" aria-labelledby="produtos-title">
    <div class="container">
      <div class="section-header">
  ...
  <section class="section section-custom" aria-labelledby="sob-medida-title">
  ...
  <section class="section section-capacity" aria-labelledby="capacidade-title">
    <div class="container">
      <div class="section-header">
  ...
  <section class="section section-projects" aria-labelledby="projetos-title">
    <div class="container split-layout reverse">
      <div class="gallery-preview" aria-label="Prévia de projetos BIRDSTEEL">
        <figure>
          ...
          <figcaption>Colagem conceitual usada como prévia visual da página de projetos.</figcaption>
        </figure>
      </div>
  ...
  <section class="section section-about" aria-labelledby="sobre-title">
    <div class="container narrow">
