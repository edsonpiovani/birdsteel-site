...
$title = 'Luminárias LED Industriais e Técnicas | BIRDSTEEL';
$description = 'Luminárias ou estruturas metálicas para iluminação funcional em racks, gabinetes, bancadas e ambientes técnicos.';
$canonical = site_url('/luminarias-led-industriais/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Luminárias LED Industriais e Técnicas</h1>
      <p class="lead">Luminárias ou estruturas metálicas para iluminação funcional em racks, gabinetes, bancadas e ambientes técnicos.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Validar se fornece luminária completa ou estrutura.</li>
<li>Potência, tensão e IP dependem de escopo.</li>
<li>Fixação e ambiente precisam ser avaliados.</li></ul>
    </aside>
  </div>
</section>
