...
$title = 'Rack para Baterias | BIRDSTEEL';
$description = 'Estruturas metálicas para bancos de baterias, energia, nobreaks, telecom e infraestrutura técnica.';
$canonical = site_url('/rack-para-baterias/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Rack para Baterias</h1>
      <p class="lead">Estruturas metálicas para bancos de baterias, energia, nobreaks, telecom e infraestrutura técnica.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Medidas conforme baterias.</li>
<li>Distribuição de peso deve ser avaliada.</li>
<li>Ambiente e acesso para manutenção importam.</li></ul>
    </aside>
  </div>
</section>
