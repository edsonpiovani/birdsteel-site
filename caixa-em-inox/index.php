...
$title = 'Caixa em Inox Sob Medida | BIRDSTEEL';
$description = 'Caixas em inox para aplicações técnicas, comerciais e industriais conforme medidas e acabamento.';
$canonical = site_url('/caixa-em-inox/');
$ogTitle = $title;
...
<section class="page-hero" aria-labelledby="page-title">
  <div class="container page-hero-grid">
    <div>
      ...
      <h1 id="page-title">Caixa em Inox Sob Medida</h1>
      <p class="lead">Caixas em inox para aplicações técnicas, comerciais e industriais conforme medidas e acabamento.</p>
    ...
    <aside class="page-hero-panel">
      ...
      <ul class="icon-list"><li>Inox 304, 316 ou 316L sob avaliação.</li>
<li>Recortes, furações, portas e fechos conforme projeto.</li>
<li>Ambiente de uso define o material.</li></ul>
    </aside>
  </div>
</section>
